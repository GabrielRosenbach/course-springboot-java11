package com.gabrielrosenbach.course.config;
...
import com.gabrielrosenbach.course.entities.Payment;
import com.gabrielrosenbach.course.entities.Product;
import com.gabrielrosenbach.course.entities.User;
import com.gabrielrosenbach.course.entities.enums.OrderStatusEnum;
import com.gabrielrosenbach.course.repositories.CategoryRepository;
import com.gabrielrosenbach.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatusEnum.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatusEnum.WAITING_PAYMENT, u1);
